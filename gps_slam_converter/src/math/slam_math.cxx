...
gps_slam_converter::math::SLAMMath::SLAMMath()
{
...
double gps_slam_converter::math::SLAMMath::distance_formula(
...
double gps_slam_converter::math::SLAMMath::angle_between_two_points(
    std::shared_ptr<gps_slam_converter::points::SLAMPoint> start_point_ptr,
    std::shared_ptr<gps_slam_converter::points::SLAMPoint> end_point_ptr)
{
    const double &start_x = start_point_ptr->get__x();
...
std::shared_ptr<gps_slam_converter::points::SLAMPoint> gps_slam_converter::math::SLAMMath::rotate_point(double x, double y, double angle)
{
    std::shared_ptr<gps_slam_converter::points::SLAMPoint> slam_point_ptr = std::make_shared<gps_slam_converter::points::SLAMPoint>();
