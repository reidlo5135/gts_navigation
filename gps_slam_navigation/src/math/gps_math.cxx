...
gps_slam_navigation::math::GPSMath::GPSMath()
{
...
double gps_slam_navigation::math::GPSMath::distance_formula_kilometers(double latitude_1, double longitude_1, double latitude_2, double longitude_2)
{
...
double gps_slam_navigation::math::GPSMath::distance_formula_meters(double latitude_1, double longitude_1, double latitude_2, double longitude_2)
{
...
double gps_slam_navigation::math::GPSMath::angle_between_two_points(double latitude_1, double longitude_1, double latitude_2, double longitude_2)
{
