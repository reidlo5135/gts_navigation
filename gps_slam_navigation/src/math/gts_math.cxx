...
gps_slam_navigation::math::GTSMath::GTSMath()
{
...
double gps_slam_navigation::math::GTSMath::calculate_rotation(std::shared_ptr<gps_slam_navigation::points::GTSPoint> gts_point_ptr)
{
