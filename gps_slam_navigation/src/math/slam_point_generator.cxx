...
gps_slam_navigation::math::SLAMPointGenerator::SLAMPointGenerator()
{
...
std::shared_ptr<gps_slam_navigation::points::SLAMPoint> gps_slam_navigation::math::SLAMPointGenerator::geo_point_to_slam_point(
    std::shared_ptr<gps_slam_navigation::points::GTSPoint> gts_point,
    std::shared_ptr<gps_slam_navigation::points::KTMPoint> ktm_point)
{
    std::shared_ptr<gps_slam_navigation::points::SLAMPoint> slam_point = std::make_shared<gps_slam_navigation::points::SLAMPoint>();

    std::shared_ptr<gps_slam_navigation::points::KTMPoint> ktm_bcm_point = gts_point->get__ktm_point_1_ptr();
...
std::shared_ptr<gps_slam_navigation::points::GeoPoint> gps_slam_navigation::math::SLAMPointGenerator::slam_point_to_geo_point(std::shared_ptr<gps_slam_navigation::points::GTSPoint> gts_point, std::shared_ptr<gps_slam_navigation::points::SLAMPoint> slam_des_point)
{
    std::shared_ptr<gps_slam_navigation::points::SLAMPoint> slam_bcm_point = gts_point->get__slam_point_1_ptr();
    ...
    std::shared_ptr<gps_slam_navigation::points::GeoPoint> geo_point = this->ktm_math_->ktm_point_to_geo_point(geo_point_x, geo_point_y);
